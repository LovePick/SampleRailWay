...
class TimeTableView: NSView {
    ...
    @objc func tapOnRemoveTime(sender:NSButton){
        ...
        let answer = dialogOKCancel(question: "Delete the time table?", text: "Are you sure you would like to delete the select time table?")
...
extension TimeTableView:TimeTableRoutineListViewDelegate{
    ...
    func routineListViewRemoveData(index: NSInteger) {
        let answer = dialogOKCancel(question: "Delete the time table?", text: "Are you sure you would like to delete this time table?")
